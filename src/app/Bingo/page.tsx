      ...
      <section>
        ...
        <div className="w-350 px-[50px] relative">
          <div
            ...
            <div>
              ...
              <Link
                href="/Login"
                className="w-[175px] bg-accent block px-4 my-16 py-3 mx-auto text-center rounded-4">
                ログイン
              </Link>
        ...
        <div className={`${currentUser ? '' : 'hidden'}`}>
          <div className="flex w-350 items-center justify-around">
            ...
            <button className="text-base font-bold py-[6px] px-2 bg-accent rounded-4 mb-4">
              追加
            </button>
          </div>
          <form className="inp w-350">
            <input
              ...
              name="task1"
              id="task1"
              className="w-350 mb-2 px-2 py-[6px] rounded-2 text-base text-darks"
            />
            <input
              type="text"
              name="task2"
            ...
            <input
              ...
              name="task4"
              id="task4"
              className="w-350 mb-8 px-2 py-[6px] rounded-2 text-base text-darks"
            />
            <button
              type="submit"
              className="block w-350 bg-accent px-4 py-3 rounded-42">
              ビンゴを作成する！
            </button>
          </form>
        </div>
